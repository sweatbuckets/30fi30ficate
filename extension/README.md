...
도메인 owner가 아직 현재 인증서를 온체인에 승인하지 않은 경우에는, extension이 평소 `Unapproved` 상태로 표시됩니다. 즉 TLS 자체는 정상이어도 30ficate 기준 추가 승인 이력이 없다는 뜻입니다.

![Extension Popup Before Approval](../readme_img/extension_before_approval.png)
